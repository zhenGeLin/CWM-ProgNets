...
class P4calc(Packet):
    ...
    fields_desc = [ StrFixedLenField("P", "P", length=1),
                    ...
                    IntField("price", 0),
                    IntField("result", 0xDEADBABE),IntField("tprice", 0),StrFixedLenField("tpricesign","+",length=1)]
    ...
    while True:
        ...
        try:
            ...
            pkt = Ether(dst='00:04:00:00:00:00', type=0x1234) / P4calc(op=ts[0].value,
                                              price=int(ts[1].value),tprice = Tprice, tpricesign = Tpricesign)
            ...
            if resp:
                p4calc=resp[P4calc]
                if p4calc:
                    Tprice = p4calc.tprice
                    Tpricesign = p4calc.tpricesign
                    price= str(p4calc.tprice)
                    pricesign = p4calc.tpricesign.decode('utf-8')
                    result = pricesign + price
                    print(result)
